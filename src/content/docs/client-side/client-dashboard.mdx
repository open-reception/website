...
1.  A modal will open. Click _Cancel_ to confirm.
    ...
    ![Appointment details with cancel button](./assets/client-dashboard/4-cancel-appointment.png)

1.  Your appointment is now cancelled and will be removed from the list.

    ![Appointment cancelled](./assets/client-dashboard/5-appointment-cancelled.png)
