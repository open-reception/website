...
:::caution
Du wirst Deinen [Passkey, der die PRF-Erweiterung unterstützt](/de/getting-started/#passkeys) für diese Anleitung benötigen.
:::
...
1. Du wirst auf einer Website landen, die Dich auffordert Dein Konto einzurichten. Klicke auf _Konto einrichten_.

   ![Claim account](./assets/setup-account/1-claim-account.png)

1. Du wirst möglicherweise einen Erfolgsmeldung für die E-Mail-Bestätigung sehen.

   ![E-Mail bestätigt](./assets/setup-account/2-email-confirmed.png)
   ...
   ![E-Mail-Bestätigung fehlgeschlagen](./assets/setup-account/2b-verification-failed.png)
...
1. Du wirst zu einem Formular weitergeleitet, in dem Du Deinen Passkey hinzufügen kannst, indem Du auf _Tippe um Passkey hinzuzufügen_ klickst.
   ...
   ![Passkey-Einrichtungsformular](./assets/setup-account/3-setup-passkey.png)
...
1. Sobald dieser Vorgang abgeschlossen ist, wird _Passkey hinzugefügt_ im **Passkey-Feld** angezeigt. Klicke jetzt auf _Passkey hinzufügen_
   ...
   ![Passkey erfolgreich hinzugefügt](./assets/setup-account/4-setup-passkey-successful.png)

1. Die siehst jetzt zwei Benachrichtigungen für das Erfolgreiche Setzen des Passkeys. Das Anmeldeformular wird angezeigt.

   ![Konto einrichten abgeschlossen](./assets/setup-account/5-account-successfully-set-up.png)
