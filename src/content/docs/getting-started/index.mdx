...
- 1Password (Software) - currently only with Safari ([see ticket](https://www.1password.community/discussions/developers/passkey-with-prf-broken-in-extensions/170866))
