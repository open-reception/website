...
OpenReception requires you to use Passkeys, which support the Pseudo-Random-Function extension (PRF). You can implement them using Software or Hardware Passkeys. For the best usability use passkeys with biometric authentification.
...
### Untested (incompatible up until v2.1.0)

- Bitwarden (Software)
- Dashlane (Software)

Last tested on June 26, 2026.
